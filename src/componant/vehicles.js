      ...
      id: 1, content:
        <div className="swiper-slide-box">
          ...
          <div className="content">
            <h3>new model</h3>
            <div className="price"> <span>price : </span> $61,000/- </div>
            <p>
              new
    ...
    },
    {
      id: 2, content:
        <div className="swiper-slide-box">
          ...
          <div className="content">
            <h3>new model</h3>
            <div className="price"> <span>price : </span> $88,000/- </div>
            <p>
              new
    ...
    },
    {
      id: 3, content:
        <div className="swiper-slide-box">
          ...
          <div className="content">
            <h3>new model</h3>
            <div className="price"> <span>price : </span> $80,000/- </div>
            <p>
              new
    ...
    },
    {
      id: 4, content:
        <div className="swiper-slide-box">
          ...
          <div className="content">
            <h3>new model</h3>
            <div className="price"> <span>price : </span> $67,000/- </div>
            <p>
              new
...
<div className='Row' >
<h1 class="heading hed"> popular <span>vehicles</span> </h1>
